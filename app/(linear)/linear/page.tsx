...
import StatCard from '@/app/(linear)/_components/StatCard';
...
const personas = [
  { name: '영업', desc: '주문 등록 · 거래처 관리', href: '/linear/orders' },
  { name: '출고', desc: '출고 준비 · 서류 관리', href: '/linear/shipments' },
  { name: '물류', desc: '피킹 · 배송 추적', href: '/linear/shipments' },
  { name: '경영관리', desc: '수금 확인 · 미수금 관리', href: '/linear/payments' },
];
